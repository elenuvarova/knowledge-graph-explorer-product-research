          ...
          {isReady && (
            <>
              ...
              <button
                ...
                aria-label="Upload a document to enrich the graph"
              >
                {uploadMutation.isPending ? '…' : <><UploadIcon /><span className="btn-label">Upload</span></>}
              </button>
              <button
                ref={briefBtnRef}
                type="button"
                ...
                aria-label="Generate a research brief"
              >
